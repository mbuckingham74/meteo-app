...
echo "  Frontend:  https://meteo-app.example.com"
echo "  API:       https://api.meteo-app.example.com/api/health"
echo ""
...
echo "     curl https://api.meteo-app.example.com/api/health"
echo "  3. Open https://meteo-app.example.com in your browser"
echo ""
