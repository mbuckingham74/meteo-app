      ...
      <div className="dashboard-skeleton-grid">
        ...
        <div className="dashboard-skeleton-left">
          ...
          <div className="skeleton-current-weather">
            <div className="skeleton-temperature-display">
              <Skeleton width="150px" height="100px" variant="rectangular" style={{ borderRadius: '12px' }} />
          ...
          <div className="skeleton-highlights">
            ...
            <div className="skeleton-highlights-grid">
              {Array.from({ length: 4 }).map((_, index) => (
                <SkeletonCard key={index} height="100px" />
              ))}
            </div>
          </div>
        ...
        <div className="dashboard-skeleton-right">
          ...
          <div className="skeleton-location-section">
            <Skeleton width="100%" height="48px" variant="rectangular" style={{ borderRadius: '8px' }} />
            <Skeleton width="100%" height="44px" variant="rectangular" style={{ borderRadius: '8px', marginTop: '1rem' }} />
            <Skeleton width="100%" height="44px" variant="rectangular" style={{ borderRadius: '8px', marginTop: '0.75rem' }} />
          </div>

          {/* Temperature Unit Toggle */}
          <div className="skeleton-unit-toggle">
            <Skeleton width="100%" height="40px" variant="rectangular" style={{ borderRadius: '8px' }} />
          </div>

          {/* Forecast Button */}
          <div className="skeleton-forecast-button">
            <Skeleton width="100%" height="56px" variant="rectangular" style={{ borderRadius: '12px' }} />
          </div>
