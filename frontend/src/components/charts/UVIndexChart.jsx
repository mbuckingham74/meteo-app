    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={height}>
        ...
        >
          ...
          <ReferenceLine y={3} stroke="#10b981" strokeDasharray="3 3" label={{ value: 'Low', position: 'right', fontSize: 10, fill: '#10b981' }} />
          <ReferenceLine y={6} stroke="#fbbf24" strokeDasharray="3 3" label={{ value: 'Moderate', position: 'right', fontSize: 10, fill: '#fbbf24' }} />
          <ReferenceLine y={8} stroke="#f97316" strokeDasharray="3 3" label={{ value: 'High', position: 'right', fontSize: 10, fill: '#f97316' }} />
          <ReferenceLine y={11} stroke="#dc2626" strokeDasharray="3 3" label={{ value: 'Very High', position: 'right', fontSize: 10, fill: '#dc2626' }} />
      ...
      {/* Sun Safety Tips */}
      <div style={{ marginTop: '12px', padding: '12px', background: '#fef3c7', borderRadius: '8px', border: '1px solid #fbbf24' }}>
        <p style={{ margin: '0 0 6px 0', fontSize: '12px', fontWeight: '600', color: '#92400e', display: 'flex', alignItems: 'center', gap: '4px' }}>
